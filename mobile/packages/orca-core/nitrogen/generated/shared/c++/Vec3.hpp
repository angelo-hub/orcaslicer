...
namespace margelo::nitro::orca {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Vec3).
   */
  struct Vec3 final {
  public:
...
namespace margelo::nitro {
  ...
  // C++ Vec3 <> JS Vec3 (object)
  template <>
  struct JSIConverter<margelo::nitro::orca::Vec3> final {
    static inline margelo::nitro::orca::Vec3 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::orca::Vec3(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::orca::Vec3& arg) {
