...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::orca::Vec2> final {
    static inline margelo::nitro::orca::Vec2 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::orca::Vec2(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::orca::Vec2& arg) {
